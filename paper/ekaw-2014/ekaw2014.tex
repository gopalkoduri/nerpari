...
\begin{table}[t]
\begin{center}
\begin{tabularx}{1\textwidth}{lllc|c|c|c|c|c|c}
\noalign{\hrule height 1.1pt}
            &  &  & \textbf{Mus.} & \textbf{Ragas} & \textbf{Sing.} & \textbf{Compositions} & \textbf{Instru.} & \textbf{Composers} & \textbf{Overall} \\
\hline
 
\multirow{6}{*}{\textbf{Carnatic}} & \multirow{3}{*}{\textbf{\#Rel.types}} 
									  & R & 10 & 5 & 3 & 0 & 5 & 3 & 17 \\
                  &                   & O & 10 & 6 & 5 & 0 & 10 & 6 & 19 \\
                  &                   & S & 12 & 7 & 10 & 0 & 9 & 7 & 27 \\
                  \cline{2-10}
                  & \multirow{3}{*}{\textbf{\#Assertions}} 
					 				  & R & 100 & 30 & 60 & 0 & 70 & 50 & 310 \\
                  &                   & O & 240 & 120 & 160 & 0 & 230 & 160 & 910 \\
                  &                   & S & 220 & 190 & 180 & 0 & 170 & 180 & 940 \\
                  \cline{1-10}
\multirow{6}{*}{\textbf{Hindustani}} & \multirow{3}{*}{\textbf{\#Rel.types}} 
                  					  & R & 8 & 0 & 7 & n/a & 12 & 1 & 18 \\
                  &                   & O & 8 & 0 & 9 & n/a & 9 & 2 & 12 \\
                  &                   & S & 12 & 0 & 12 & n/a & 12 & 2 & 22 \\
                  \cline{2-10}
                  & \multirow{3}{*}{\textbf{\#Assertions}} 
                  					  & R & 140 & 0 & 130 & n/a & 150 & 10 & 430 \\
                  &                   & O & 310 & 0 & 310 & n/a & 320 & 150 & 1090 \\
                  &                   & S & 290 & 0 & 260 & n/a & 280 & 150 & 880 \\
\noalign{\hrule height 1.1pt}
\end{tabularx}
\end{center}
\caption{Semantic relation extraction task: The number of valid relation types marked for each
concept, and the number of corresponding assertions that include the entities in the domain. R, O and S stand for ReVerb, OpenIE4.0 and Sem. Parsing systems respectively.}
\label{tab:qual-semantic-relex}
\end{table}
}
